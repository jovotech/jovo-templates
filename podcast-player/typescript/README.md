# Jovo Template: Podcast Player

This template contains a Jovo Sample Voice App in TypeScript with a simple demo for a podcast player.
...
```sh
$ jovo new <directory> --template podcast-player --language typescript
```
...
Now that you got the template running on the Jovo Debugger, you can take a closer look at the Podcast Player course, which you can find [here](https://www.jovo.tech/courses/project-3-podcast-player).
