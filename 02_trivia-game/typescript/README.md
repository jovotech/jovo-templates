# Jovo Template: Trivia Game

This template contains a Jovo Sample Trivia Voice App in TypeScript, a simple quiz game, where the user gets asked several questions about trivia knowledge.
...
```sh
$ jovo new <directory> --template trivia-game --language typescript
```
