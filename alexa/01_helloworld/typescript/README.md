# Jovo Template: Hello World on Amazon Alexa

This template contains a Jovo Sample Alexa Skill in TypeScript, with a simple "Hello World!" greeting, asking for the user's name and returning a personalised message.
...
Now that you got the template running on the Jovo Debugger, it is time to deploy your Alexa skill! You can find a tutorial for building a complete Alexa skill [here](https://www.jovo.tech/tutorials/alexa-skill-tutorial-nodejs).
