# Jovo Template: Alexa Presentation Language (APL)

This template contains a Jovo Sample Voice App in TypeScript, that uses the Alexa Presentation Language (APL) to display visual responses on devices with a screen.
...
```sh
$ jovo new <directory> --template alexa/apl --language typescript
```
