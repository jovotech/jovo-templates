# Jovo Template: Alexa Skill Events

This template contains a Jovo Sample Voice App in TypeScript with an example implementation of Alexa Skill Events.
...
```sh
$ jovo new <directory> --template alexa/skillevents --language typescript
```
...
Now that you got the template running on the Jovo Debugger, you can check out the tutorial on Alexa Skill Events. You can find it [here](https://www.jovo.tech/tutorials/alexa-skill-events).
