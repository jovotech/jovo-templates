# Jovo Template: Alexa Audioplayer

This template contains a Jovo Sample Voice App in TypeScript, that plays a longform audio file with the Audioplayer directive.
...
```sh
$ jovo new <directory> --template alexa/audioplayer --language typescript
```
