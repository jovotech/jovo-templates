...
This template contains a Jovo Sample Autopilot Bot that can handoff the session to a human agent using Twilio Flex.
...
```sh
$ jovo new <directory> --template autopilot/handoff
```
