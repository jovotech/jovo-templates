# Jovo Template: Handoff on Twilio Autopilot

This template contains a Jovo Sample Autopilot Bot in TypeScript that can handoff the session to a human agent using Twilio Flex.
...
```sh
$ jovo new <directory> --template autopilot/handoff --language typescript
```
...
Now that you got the template running, it is time that you build your corresponding Autopilot bot! To get started, you can take a look at a tutorial [here](https://www.jovo.tech/tutorials/twilio-autopilot-hello-world).
