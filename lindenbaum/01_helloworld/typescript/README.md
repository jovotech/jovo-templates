# Jovo Template: Hello World on Lindenbaum

This template contains a Jovo Sample Lindenbaum Cognitive Voice bot with a simple "Hello World!" greeting, asking for the user's name and returning a personalized message. This is the default template for the `jovo new` command.
...
```sh
$ jovo new <directory> --template lindenbaum --language typescript
```
