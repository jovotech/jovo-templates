...
This template contains a Jovo Sample Bixby Capsule, that plays a longform audio file with the Bixby AudioPlayer functionality.
...
```sh
$ jovo new <directory> --template bixby/audioplayer
```
