# Jovo Template: Hello World with i18n

This template contains a Jovo Sample Voice App in TypeScript with a simple "Hello World!" greeting, asking for the user's name and returning a personalised message, that uses the [Jovo i18next integration](https://www.jovo.tech/docs/output/i18n).
...
```sh
$ jovo new <directory> --template i18n --language typescript
```
